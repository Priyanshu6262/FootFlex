...
const Kids = () => {
  ...
  const activeFilters = filterState.kids;
  ...
  const handleFilterChange = (filterType, value) => {
    if (filterType === 'clear') {
      clearAllFilters('kids');
      return;
    }
    toggleFilter('kids', filterType, value);
  };
  ...
  return (
    <div className="min-h-screen pb-15 bg-background-main">
      {loading ? (
