...
const Women = () => {
  ...
  const activeFilters = filterState.women;
  ...
  const handleFilterChange = (filterType, value) => {
    if (filterType === 'clear') {
      clearAllFilters('women');
      return;
    }
    toggleFilter('women', filterType, value);
  };
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
              ...
              <div className="flex items-center gap-3">
                ...
                {/* Sort Component */}
                <SortDropdown sortBy={sortBy} onSortChange={(value) => setSort('women', value)} />
              </div>
            </div>

            {/* Active Filter Chips */}
            <ActiveFilters pageKey="women" />
